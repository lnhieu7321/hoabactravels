                              ...
                              child: Container(
                                ...
                                child: TextButton(
                                  onPressed: () {
                                    ...
                                    // Parse input values
                                    final numberOfAdults = int.parse(_number.toStringAsFixed(2));
                                    total_cost = double.parse(total_cost.toStringAsFixed(2));
                                    final totalCost = double.parse(total_cost.toString());

                                    // Create booking model
                                    final bookingModel = BookingModel(
                                      typeOfDay: _selectedName,
                                      numberOfAdults: numberOfAdults,
                                      startDate: _selectedArrivalDate.toIso8601String(),
                                      endDate: _selectedDepartureDate.toIso8601String(),
                                      totalCost: totalCost,
                                      servicesId: int.parse(widget.serviceId!),
                                    );

                                    // Create booking
                                    _bookingController.createBooking(bookingModel);
                                  },
